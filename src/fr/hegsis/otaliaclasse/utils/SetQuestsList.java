...
public class SetQuestsList {
    ...
    public static List<Quest> setPirateQuests() {
        List<Quest> questList = new ArrayList<>();

        FileConfiguration pqfc = YamlFileUtils.getFileConfiguration(YamlFiles.PIRATE_QUESTS); //pqfc → pirateQuestsFileConfiguration
        ConfigurationSection cs = pqfc.getConfigurationSection("quests");
        if (cs!=null) {
            int questId;
            QuestType questType;
            QuestAction questAction;
